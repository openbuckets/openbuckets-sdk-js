...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBucketsApi.BucketSearchResultsBucketsInner();
  });
  ...
  describe('BucketSearchResultsBucketsInner', function() {
    it('should create an instance of BucketSearchResultsBucketsInner', function() {
      // uncomment below and update the code to test BucketSearchResultsBucketsInner
      //var instance = new OpenBucketsApi.BucketSearchResultsBucketsInner();
      //expect(instance).to.be.a(OpenBucketsApi.BucketSearchResultsBucketsInner);
    });
