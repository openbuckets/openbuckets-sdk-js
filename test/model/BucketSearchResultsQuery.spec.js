...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBucketsApi.BucketSearchResultsQuery();
  });
  ...
  describe('BucketSearchResultsQuery', function() {
    it('should create an instance of BucketSearchResultsQuery', function() {
      // uncomment below and update the code to test BucketSearchResultsQuery
      //var instance = new OpenBucketsApi.BucketSearchResultsQuery();
      //expect(instance).to.be.a(OpenBucketsApi.BucketSearchResultsQuery);
    });
