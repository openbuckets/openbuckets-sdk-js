...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenBucketsApi.BucketsApi();
  });
  ...
  describe('BucketsApi', function() {
    describe('searchBuckets', function() {
      it('should call searchBuckets successfully', function(done) {
        //uncomment below and update the code to test searchBuckets
        //instance.searchBuckets(function(error) {
